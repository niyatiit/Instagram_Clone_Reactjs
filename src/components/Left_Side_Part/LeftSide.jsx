...
function LeftSide() {
  return (
    <div className=' flex w-[200px] border-r-[1px] border-black flex-col gap-0 justify-center'>
      <img src="https://images.squarespace-cdn.com/content/v1/5a4fc7372278e71e0c8451e1/1517602667538-ZXGZKVL9M7DLL9Z7HFA0/2nd.png" alt="" className=' w-28 self-center mb-2' />
      <div class="mainLink">
        <div class='navlink'>
      ...
      <div className=' p-3'>
        ...
        <div className="mainLink mt-5 px-5 py-3 border-[1px] border-black rounded-lg w-full items-center flex gap-5">
